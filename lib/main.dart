...
class DepartmentIntroScreen extends StatelessWidget {
  ...
  static const List<Map<String, dynamic>> departments = [
    ...
    },
    {
      ...
      'code': 'SW',
      'keywords': ['소프트웨어', '웹', '앱', '서비스', '개발'],
      'intro': '소프트웨어 서비스와 응용 프로그램 개발 역량을 기르는 전공입니다.',
      'learn': ['프로그래밍', '웹/앱 개발', '데이터베이스', '소프트웨어 설계', '프로젝트'],
      'career': ['웹 개발자', '앱 개발자', '서비스 개발자', 'IT 기획자'],
      'transfer': '전과 관심자는 프로그래밍 기초와 간단한 앱/웹 결과물을 만들어보는 것이 좋습니다.',
      'nasumi': '소프트웨어학 나섬이',
      'mission': 'SW-NASUMI',
      'status': '확인 필요',
    },
    {
      ...
      'building': '정보과학관 / 확인 필요',
      'code': 'SEC',
      'keywords': ['보안', '네트워크', '해킹방어', '시스템'],
      'intro': '정보 시스템을 안전하게 보호하기 위한 보안 기술을 배우는 전공입니다.',
      'learn': ['네트워크', '운영체제', '암호학', '웹 보안', '침해 대응'],
      'career': ['보안 엔지니어', '관제 분석가', '침해 대응 담당자', '보안 컨설턴트'],
      'transfer': '전과 관심자는 네트워크, 리눅스, 프로그래밍 기초를 먼저 익히는 것이 좋습니다.',
      'nasumi': '정보보안학 나섬이',
      'mission': 'SEC-NASUMI',
      'status': '확인 필요',
    },
    ...
    },
    {
      ...
      'building': '확인 필요',
      'code': 'DRONE',
      'keywords': ['드론', '로봇', '제어', '임베디드', '자율주행'],
      'intro': '드론, 로봇, 제어 시스템과 피지컬 AI 기술을 다루는 전공입니다.',
      'learn': ['로봇 기초', '제어', '센서', '임베디드', '자율 시스템'],
      'career': ['로봇 개발자', '드론 개발자', '제어 엔지니어', '임베디드 개발자'],
      'transfer': '전과 관심자는 C/C++, 수학, 센서/하드웨어 기초를 준비하면 좋습니다.',
      'nasumi': '드론로봇공학 나섬이',
    ...
    },
    {
      ...
      'building': '확인 필요',
      'code': 'AIE',
      'keywords': ['전자', '회로', 'AIoT', '센서', '임베디드'],
      'intro': '전자공학과 AI/IoT 기술을 융합해 하드웨어 기반 시스템을 배우는 전공입니다.',
      'learn': ['전자회로', '센서', '마이크로컨트롤러', '통신', 'AIoT'],
      'career': ['전자 엔지니어', '임베디드 개발자', 'IoT 개발자', '하드웨어 엔지니어'],
      'transfer': '전과 관심자는 회로 기초, C언어, 전자부품 이해를 준비하면 좋습니다.',
      'nasumi': 'AI융합전자 나섬이',
      'mission': 'AIE-NASUMI',
      'status': '확인 필요',
    },
    ...
    },
    {
      ...
      'building': '확인 필요',
      'code': 'MEDIA',
      'keywords': ['광고', '사진', '영상', '콘텐츠', '브랜딩'],
      'intro': '광고, 사진, 영상 콘텐츠 제작과 시각 커뮤니케이션을 배우는 학과입니다.',
      'learn': ['사진', '영상 제작', '광고 기획', '콘텐츠 편집', '브랜딩'],
      'career': ['영상 제작자', '광고 기획자', '콘텐츠 디자이너', '브랜드 마케터'],
      'transfer': '전과 관심자는 촬영/편집 결과물과 시각 표현 포트폴리오를 준비하면 좋습니다.',
      'nasumi': '광고사진영상학과 나섬이',
      'mission': 'MEDIA-NASUMI',
      'status': '확인 필요',
    },
    {
      'name': '아트앤웹툰',
      ...
      'building': '확인 필요',
      'code': 'WEBTOON',
      'keywords': ['웹툰', '드로잉', '스토리', '캐릭터', '콘텐츠'],
      'intro': '웹툰과 시각 콘텐츠 제작 역량을 기르는 전공입니다.',
      'learn': ['드로잉', '스토리텔링', '캐릭터', '디지털 작업', '콘텐츠 제작'],
      'career': ['웹툰 작가', '일러스트레이터', '콘텐츠 작가', '캐릭터 디자이너'],
      'transfer': '전과 관심자는 드로잉 습관과 개인 작업물 포트폴리오가 중요합니다.',
      'nasumi': '아트앤웹툰 나섬이',
    ...
    },
    {
      ...
      'building': '확인 필요',
      'code': 'ANIMATION',
      'keywords': ['애니메이션', '게임그래픽', '캐릭터', '3D', '콘텐츠'],
      'intro': '게임과 애니메이션 시각 콘텐츠 제작을 배우는 전공입니다.',
      'learn': ['애니메이션', '3D 그래픽', '캐릭터 디자인', '콘텐츠 제작', '포트폴리오'],
      'career': ['애니메이터', '게임 그래픽 디자이너', '3D 아티스트', '콘텐츠 제작자'],
      'transfer': '전과 관심자는 그림/그래픽 작업물과 꾸준한 포트폴리오 관리가 중요합니다.',
      'nasumi': '게임애니메이션 나섬이',
